...
this is the repo you should clone first. this repo will setup every other repo.
...
```powershell
    ...
    git remote set-url origin --push --addgit@github.com:christojeffrey/Binotify-App.git
    cd ..
